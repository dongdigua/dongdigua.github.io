...
zed 也让我省去了手动写脚本监控文件系统的麻烦，关于如何测试 zed，[[https://rair.dev/zfs-smart-ntfy][在这]]看到了一个[[https://github.com/openzfs/zfs/issues/4511][小妙招]]。
还有一个细节是 zfs 的快照目录 [[https://szclsya.me/zh-cn/posts/storage/zfs-maintenance/#footnote-1][.zfs 用 ls -a 看不见但 cd 可以进入]]

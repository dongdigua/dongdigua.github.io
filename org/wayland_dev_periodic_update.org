...
追问之后告诉我用 poll 的 timeout。我恍然大悟为什么之前被我当作参考实现的 [[git.sr.ht/~leon_plickat/wayloadmon][wayloadmon]] 要引入 poll 了。
...
* calloop
也是 ChatGPT 提到的，并且还有个 [[calloop-wayland-source][https://github.com/Smithay/calloop-wayland-source]] 可以省去一些麻烦。
